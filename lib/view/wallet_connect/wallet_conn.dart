...
import 'package:de_pay/view/wallet_connect/eth_coversion.dart';
import 'package:web3dart/crypto.dart';
import 'package:web3dart/web3dart.dart';



class WalletConn extends StatefulWidget {
  // ignore: prefer_const_constructors_in_immutables
  WalletConn({Key? key, }) : super(key: key);

 

  @override
  _WalletConnState createState() => _WalletConnState();
}
...
class _WalletConnState extends State<WalletConn> {
                ...
                case MenuItems.PASTE_CODE:
                  showGeneralDialog(
                      ...
                      pageBuilder: (context, _, __) {
                        return SimpleDialog(
                          title: Text('Bağlanmak için kodu yapıştırın'),
                          titlePadding:
            ...
            itemBuilder: (_) {
              return [
                PopupMenuItem(
                  ...
                  child: Text('Önceki Oturumu Bağla'),
                ),
                PopupMenuItem(
                ...
                PopupMenuItem(
                  ...
                  child: Text('QR ile bağlanın'),
                ),
                PopupMenuItem(
                  value: MenuItems.PASTE_CODE,
                  child: Text('Kod ile Bağlan'),
                ),
                PopupMenuItem(
  ...
  _connectToPreviousSession() {
    ...
    if (_sessionStore != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        content: Text('Önceki Cüzdan Bulunamadı.'),
      ));
    }
  }
